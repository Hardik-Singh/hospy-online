...
export const hospitalMonitorRules: MonitorRule[] = [
  {
    ...
    natural_language: 'Alert when heart rate exceeds 100 bpm or drops below 60 bpm',
    severity: 'high',
  ...
  },
  {
    ...
    name: 'Hypoxia',
    natural_language: 'Alert when oxygen saturation drops below 95%',
    severity: 'critical',
    agent_id: 'hospy/nurse-ward-a',
  },
  {
    key: 'nurse-vitals-bp',
    name: 'Blood Pressure',
    natural_language: 'Alert when systolic blood pressure exceeds 140 or drops below 90',
    severity: 'high',
    agent_id: 'hospy/nurse-ward-a',
  },
  {
    ...
    name: 'Fever',
    natural_language: 'Alert when patient temperature exceeds 100.4 F',
    severity: 'medium',
    agent_id: 'hospy/nurse-ward-a',
  },
  {
